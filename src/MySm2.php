 ...
 * Time: 10:15
 */
namespace Xiuchuan\Ecc;


use Xiuchuan\Ecc\Crypto\Signature\Sm2Signer;
use Xiuchuan\Ecc\EccFactory;
use Xiuchuan\Ecc\Crypto\Key\PrivateKey;
use Xiuchuan\Ecc\Crypto\Key\PublicKey;
use Xiuchuan\Ecc\Primitives\Point;
use Xiuchuan\Ecc\Serializer\PrivateKey\PemPrivateKeySerializer;
use Xiuchuan\Ecc\Serializer\PrivateKey\DerPrivateKeySerializer;
use Xiuchuan\Ecc\Serializer\PublicKey\PemPublicKeySerializer;
use Xiuchuan\Ecc\Serializer\PublicKey\DerPublicKeySerializer;
use Xiuchuan\Ecc\Serializer\Signature\DerSignatureSerializer;

use Xiuchuan\Ecc\SM2\Sm2WithSm3;
...
class MySm2 {
    ...
    protected function _dosign( $document, $key, $adapter,$generator, $userId, $algorithm = 'sha256' ) {
        ...
        if ( $this->useDerandomizedSignatures ) {
            $random = \Xiuchuan\Ecc\Random\RandomGeneratorFactory::getHmacRandomGenerator( $key, $hash, $algorithm );
        } else {
            $random = \Xiuchuan\Ecc\Random\RandomGeneratorFactory::getRandomGenerator();
        }
